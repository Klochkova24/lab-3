...
18. На рисунке 19 представлены терминалы всех трёх виртуальных машин. Видно, что машина А имеет доступ к машинам В и С, машина С имеет доступ к машинам А и В, машина В имеет доступ к машине А, но не имеет доступа к машине С (отправлены 7 пакетов запросов, ни один не доставлен, все потеряны). Также все машины имеют доступ в интернет. По умолчанию должно отправляться 4 пакета, но в этом случае все терминалы не влезут на экран, поэтому каждый запрос, кроме запроса от машины В к машине С ограничился 3 пакетами.
